...
const Index = () => {
  ...
  const reviews = [
    ...
    },
    {
      name: 'Мария С.',
      role: 'Психолог',
      text: 'Парная терапия помогла нам с мужем преодолеть кризис после измены. Александр создал безопасное пространство, где мы научились слышать друг друга. Спасибо за профессионализм и поддержку!',
      rating: 5,
    },
    {
      name: 'Дмитрий В.',
