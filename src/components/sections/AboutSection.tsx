            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p className="text-lg font-medium text-foreground">
                  Разрешите представиться, меня зовут Гонтарь Александр Игоревич. Я психолог по профессиональному выгоранию, 
                  менеджменту и цифровому детоксу. А также предприниматель в области пассажирских перевозок и дополнительного образования.
                </p>
                <p>
                  И не по наслышке знаю и вижу каждый день, как хроническое перенапряжение выжигает людей изнутри.
                </p>
                <p className="font-medium text-foreground">
                  За годы практики я выявил закономерность: большинство проблем напрямую или косвенно связаны с 
                  <strong> профессиональным выгоранием и эмоциональным истощением</strong>, вызванным хроническим перенапряжением.
                </p>
                <p>
                  Игнорирование выгорания приводит к развитию клинической депрессии, где одной терапии уже недостаточно. 
                  Наше внутреннее состояние влияет на все сферы жизни и все решения.
                </p>
              </div>
